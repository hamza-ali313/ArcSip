  ...
  return (
    ...
    <div className='nada-dashboard'>
              ...
              <Row>
                <Col md={2}>
                  <div className='dashb-heading'>
                    <img src={mdean} alt='' /><h3>Phone Numbers</h3>
                  </div>
                </Col>
                ...
                <Col md={10}>
                  <div className='top-bar'>
                    ...
                    <div className='day-night'>
                      ...
                      <Button type="submit" className="btn btn-primary day"><img src={day} alt='' /> </Button>

                      <Button type="submit" className="btn btn-primary night"><img src={night} alt='' /> </Button>
                    ...
                    <div className='tot-crd'>
                      <p>Total Credits     <img src={dolar} alt='' />   28.94</p>
                      <Button type="submit" className="btn btn-primary day"><FontAwesomeIcon icon={solid('plus')} />ADD </Button>
                    </div>
                    ...
                    <Row>
                      <Col md={3}>
                        <div className='percent-call'>
                          ...
                          <h5>0%   <span>Service Level</span></h5>

                          <div className='incoming-seccond'>

                            <p>Percentage of incoming calls answered in less than
                              <span>
                      ...
                      <Col md={3}>
                        <div className='calling-sys pink'>
                          <img src={outcal} alt='' />
                          <h5>(0)  <span>Calls Mode</span></h5>
                        </div>

                        <div className='calling-sys  missed'>
                          <img src={missed} alt='' />
                          <h5>(0)  <span>Calls outside office hours</span></h5>
                        </div>
                      </Col>
                      ...
                      <Col md={3}>
                        <div className='calling-sys agent'>
                          <img src={agent} alt='' />
                          <h5>(0)  <span>Calls Answered</span></h5>
                        </div>
                        ...
                        <div className='calling-sys ring'>
                          <img src={ring} alt='' />
                          <h5> (0) <span>Avg. Answer Time</span></h5>
                        </div>
                      </Col>
                      ...
                      <Col md={3}>
                        ...
                        <div className='calling-sys avgtime'>
                          <img src={olred} alt='' />
                          <h5> TBA <span>Avg. Answer Time</span></h5>
                        </div>
                  ...
                  <Row>
                    <Col md={3}>
                      <div className='calling-sys team'>
                        <img src={team} alt='' />
                        <h5> 0% <span>Team Connect rate</span></h5>
                      </div>
                    </Col>
                  </Row>
                </Col>
                      ...
                      <Table>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><img className='tl-mem' src={fal} alt='' /> Prime Web Solutions <span>(210) 939-9341</span> </td>

                            <td>72 <span>(ihr 16min 30sec)</span> 	</td>

                            <td>2 <span>(ihr 16min 30sec)</span> 	</td>

                            <td><Button type="submit" className="btn btn-primary live">0</Button></td>
                      ...
                      <Table>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><img className='tl-mem' src={usama} alt='' /> Usama Akhtar <span>Available</span>  </td>
      ...
      <Dropdown.Item href="#/action-3">Something else</Dropdown.Item>
                  ...
                  <div className='not-miss devider'>
                    <Row>
                      ...
                      <img src={picht} alt='' />
                      <p>No data to show for <span>This Time Fram</span> </p>
                      </div>
                      </Col>

                     <Col md={6}>
                  <div className='di-dcon'>
                  <h3>Not enough <span>data</span></h3>
                  </div>
                     </Col>
      ...
      <Dropdown.Item href="#/action-3">Something else</Dropdown.Item>
                  ...
                  <h3>No Calls Made With Any <span>Disposition Code In Selected Time Range </span></h3>
                  </div>
                </div>
